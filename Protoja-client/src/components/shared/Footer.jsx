...
function Footer() {
  ...
  return (
    <div className="flex overflow-hidden flex-col pt-24 bg-neutral-900">
      ...
      <div className="flex items-center px-9 pt-7 pb-6 w-full border-t border-solid border-t-neutral-700 max-md:px-5 max-md:max-w-full">
        <div className="flex overflow-hidden flex-1 shrink justify-between items-center self-stretch px-10 my-auto w-full basis-0 max-w-[1370px] min-w-[240px] max-md:px-5 max-md:max-w-full">
          <div className="flex flex-wrap flex-1 shrink gap-5 justify-between self-stretch py-2.5 my-auto w-full basis-0 min-w-[240px] max-md:max-w-full">
            <div className="flex flex-col my-auto text-base leading-none text-zinc-400">
