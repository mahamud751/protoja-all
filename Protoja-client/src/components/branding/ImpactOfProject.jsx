export default function ImpactOfProject() {
    const metrics = [
      { id: "01", title: "Improve Retention rate", value: "19%", bgColor: "bg-black text-white" },
      { id: "02", title: "Increase weekly Active User", value: "25%", bgColor: "bg-white text-black border" },
      { id: "03", title: "Average app Rating", value: "5.00", bgColor: "bg-black text-white" },
    ];
