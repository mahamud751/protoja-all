...
export default function StatisticsGrid() {
    return (
        <>
            <div className="bg-black text-white px-6 md:px-10">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-gray-900 p-6 rounded-lg shadow-md text-center ">
                        <p className="text-gray-400 text-sm text-white">Insert some statistic</p>
                        <h2 className="text-xl font-semibold mt-2 text-white">Key feature</h2>
                        <p className="text-gray-500 text-lg mt-1">Insert some statistic or metric name</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 p-8 rounded-lg flex flex-col justify-center items-center text-center">
                        <p className="text-white text-sm opacity-80">Insert some statistic</p>
                    ...
                    <div className="bg-gray-900 p-6 rounded-lg shadow-md text-center">
                        <p className="text-gray-400 text-sm">Machine learning suggestions</p>
                        <h2 className="text-3xl font-semibold mt-2 text-blue-500">Ship faster <br /> with AI</h2>
                    </div>
            ...
            {/* Style Guide */}
            <Info bgColor={"bg-white"} textColor={"text-black"} tittle={`Style Guide`} description={` The problem is Costwise previously have an unorganized management system. Where navigating was much more complex also UI was there one of the issues. Besides this the previous one doesn’t have any AI-bot.which we had to maintain.`} />
