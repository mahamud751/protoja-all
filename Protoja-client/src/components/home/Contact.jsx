  ...
  return (
    <Box className={`${page === "create" ? "bg-[#E8E8E8]" : "bg-[#272727]"}`}>
      <div
        ...
        ref={ref}
      >
        <div className="flex flex-col pb-48 w-full min-h-[899px] max-md:pb-24 max-md:max-w-full">
          <div className="flex flex-wrap gap-2 items-center self-center mt-28 mb-0 max-md:mt-10 max-md:mb-2.5 max-md:max-w-full">
